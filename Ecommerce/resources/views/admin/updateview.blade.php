                    ...
                    <div class="container-custom">
                        ...
                        <form action="{{ url('updateproduct',$data->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="description" name="des"  value="{{$data->description}}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <img src="/productimage/{{$data->image}}" alt="{{$data->title}}" style="width: 100px; height: 100px;">
                            </div>

                            <div class="form-group">
                                <label>change the Image</label>
                                <div class="file-upload">
                                    <input type="file" id="image" name="file" hidden accept="image/*" >
